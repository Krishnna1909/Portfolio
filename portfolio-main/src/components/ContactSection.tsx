...
export default function ContactSection() {
    ...
    const handleSend = async () => {
        ...
        // Web3Forms Access Key (Placeholder for user to replace)
        const accessKey = "17d06ade-d1b2-4921-886a-62990b8c91c4";

        if (accessKey === "YOUR_WEB3FORMS_ACCESS_KEY" || !accessKey) {
            // Fallback: opens mailto link if key is not configured yet
            const email = portfolioData.personal.email;
            const subject = encodeURIComponent(`Portfolio Inquiry from ${form.name}`);
            const body = encodeURIComponent(`Hello Krishna,\n\n${form.message}\n\nBest regards,\n${form.name}`);
    ...
    animate-[shine_4s_linear_infinite]"
                ...
                hover:shadow-[0_0_25px_rgba(255,255,255,0.12)]"
                    ...
                    group-hover:opacity-100 transition-opacity duration-300"
                            ...
                            {/* whatsapp */}
                            <a
                                href={`https://wa.me/${portfolioData.personal.whatsappNumber}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group relative w-12 h-12 sm:w-14 sm:h-14 rounded-2xl
                border border-white/10
                            ...
                            <div className="relative z-10 p-6 sm:p-7 space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-sm text-white/35 leading-relaxed">
                                         Your message opens directly in your email client—no spam, just real connection.
                                     </p>
                                </div>
  ...
  animate-[headingReveal_1s_cubic-bezier(0.22,1,0.36,1)_0.15s_forwards]"
    ...
    bg-clip-text text-transparent"
        ...
        shadow-[0_10px_30px_rgba(0,0,0,0.28)]
        transition-all duration-500 ease-out
        hover:-translate-y-1.5 hover:scale-105 hover:border-orange-500/50"
                        >
                            <div className="absolute inset-0 bg-gradient-to-br from-orange-500/18 via-yellow-400/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                            <div className="absolute inset-[1px] rounded-[19px] bg-[#0b0b12]/80" />
                            <div className="absolute -inset-6 bg-orange-500/0 blur-2xl transition-all duration-500 group-hover:bg-orange-500/20" />

                            <SiLeetcode className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110 group-hover:text-orange-500" />
                        </a>
                    </div>
                    ...
                    <p className="text-center text-sm tracking-[0.22em] text-white/35">
                      ...
                      <span className="relative inline-block text-white/70 font-semibold uppercase">
