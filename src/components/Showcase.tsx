...
const techStack = portfolioData.skills.all;
...
function ProjectCard({ item }: { item: Project }) {
  return (
    ...
    >
      ...
      {/* Title & Description section (below the image) */}
      <div className="p-5 flex flex-col justify-between flex-grow gap-4">
        ...
        {/* Tech Stack & Navigation Links */}
        <div className="flex items-center justify-between pt-4 border-t border-white/10">
          <span className="text-[9px] uppercase tracking-[0.2em] text-white/40 font-mono max-w-[65%] line-clamp-2 leading-normal">
            {item.tech}
          </span>
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-center gap-3 text-white/40">
        ...
        <span className="text-[10px] uppercase tracking-[0.4em] font-mono">
          {techStack.length} technologies · full stack & AI
        </span>
        ...
        >
          ...
          {tabs.map((tab) => (
            <button
              ...
              className="relative z-10 flex-1 h-12 rounded-full text-xs font-medium tracking-wide transition-colors duration-200 cursor-pointer"
            >
              <span
                className={
                  active === tab.id
